...
const TRANSLATIONS = {
  pt: {
    ...
    useCmd: {
      ...
      noPet: '❌ Você não possui nenhum Pymon ativo para receber este item! Inicie sua jornada usando `/py-pymons`.',
      noItem: '❌ Você não possui este item na sua mochila. Compre na `/py-shop` ou obtenha em `/py-pymons` (Dungeons).',
      ...
      success: '✨ Você utilizou **{emoji} {name}** no seu Pymon **{petName}**!{effects}{status}{levelMsg}\nUse `/py-pymons` para conferir o cartão atualizado.',
      needItemPrefix: '❌ Informe o item que deseja usar. Exemplo: `py!use racao_floresta` (ou use `/py-use`).',
    },
    dexCmd: {
    ...
    invite: {
      ...
      desc: 'Leve a magia da **Pyxie** para a sua comunidade! Um bot completo de RPG de mascotes (Pymons), masmorras 2D, economia mágica, tarot e jogos interativos para animar seus membros.',
      petsTitle: '🐾 Pymons & Masmorras 2D',
      petsDesc: 'Colete criaturas mágicas, explore masmorras com D-Pad, choque ovos e enfrente o World Boss com seus amigos!',
      ...
      footer: 'Pyxie • Magia, Mascotes & Comunidade para o seu Servidor',
    },
  },
  en: {
    common: {
    ...
    useCmd: {
      ...
      noPet: '❌ You do not have an active Pymon to receive this item! Begin your journey with `/py-pymons`.',
      noItem: '❌ You do not have this item in your backpack. Buy it in `/py-shop` or find it in `/py-pymons` (Dungeons).',
      ...
      success: '✨ You used **{emoji} {name}** on your Pymon **{petName}**!{effects}{status}{levelMsg}\nUse `/py-pymons` to see the updated card.',
      needItemPrefix: '❌ Please specify the item to use. Example: `py!use racao_floresta` (or use `/py-use`).',
    },
    dexCmd: {
    ...
    invite: {
      ...
      desc: 'Bring the magic of **Pyxie** to your community! A feature-packed Discord bot with pet RPG (Pymons), 2D dungeons, magical economy, mystical tarot, and engaging community minigames.',
      petsTitle: '🐾 Pymons & 2D Dungeons',
      petsDesc: 'Collect magical creatures, explore 2D dungeons with D-Pad buttons, hatch eggs, and fight World Bosses!',
      ...
      footer: 'Pyxie • Magic, Pets & Community for your Server',
    },
  },
};
