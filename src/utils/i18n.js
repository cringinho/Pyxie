...
const TRANSLATIONS = {
  "pt": {
    ...
    "vote": {
      ...
      "rewardCoins": "> 🪙 **+50 Moedinhas** no cofre",
    ...
    "album": {
      ...
      "claimSuccess": "🎉 Parabéns! Você resgatou a conquista **{name}** e recebeu **+{coins} Moedas**! Seu novo saldo é de **{balance} Moedinhas**.",
    ...
    "gloom": {
      ...
      "boss": {
        ...
        "btnAttack": "Investida no Chefão (1x Grátis)",
        "btnAttackExtra": "Investida Extra Desbloqueada!",
  ...
  "en": {
    ...
    "vote": {
      ...
      "rewardCoins": "> 🪙 **+50 Coins** in your vault",
    ...
    "album": {
      ...
      "claimSuccess": "🎉 Congratulations! You claimed achievement **{name}** and received **+{coins} Coins**! Your new balance is **{balance} Coins**.",
    ...
    "gloom": {
      ...
      "boss": {
        ...
        "btnAttack": "Boss Strike (1x Free)",
        "btnAttackExtra": "Extra Strike Ready!",
